          ...
          <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100 img-fluid" src="../images/bg1_01.jpg" alt="First slide">
              ...
              <div class="carousel-item">
                <img class="d-block w-100" src="../images/bg2_01.jpg" alt="Second slide">
                <div class="carousel-caption d-md-block ">
                  <h5>nature</h5>
                  <p>how about that</p>
                </div>             
              ...
              <div class="carousel-item">
                <img class="d-block w-100" src="../images/bg3_01.jpg" alt="Third slide">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12 col-md-4">
              <div class="card disp_card" style="width:100%;">
                <img class="card-img-top" src="../images/ngologo2.jpg" alt="Card image cap">
                <div class="card-body">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="card disp_card" style="width: 100%;">
                <img class="card-img-top" src="../images/ngologo3.png" alt="Card image cap">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="#" class="btn btn-primary">Go somewhere</a>
            ...
            <div class="col-sm-12 col-md-4">
              <div class="card disp_card" style="width:100%;">
                <img class="card-img-top" src="../images/ngologo4.png" alt="Card image cap">
                <div class="card-body">
                  <h5 class="card-title">Card title</h5>
                  <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  <a href="#" class="btn btn-primary">Go somewhere</a>
